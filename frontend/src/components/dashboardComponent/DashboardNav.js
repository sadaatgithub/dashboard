  ...
  return (
    ...
    <ul className="flex-grow mt-10 flex flex-col text-sm text-gray-100 font-normal gap-y-2
     ...
     [&>*]:transition-all duration-500 ease-in pt-8">
        ...
        <Link to="/pwh-data"><li className="flex items-center gap-x-2"><FaUsers size="15" className=""/>View All</li></Link>
        <Link to="/add"><li className="flex items-center gap-x-2"><FaPlusCircle  size="15" className=""/>Add New</li></Link>
